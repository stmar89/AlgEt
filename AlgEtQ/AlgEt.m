...
intrinsic EtaleAlgebra(f::RngUPolElt[RngQZ]) -> AlgEtQ
{Given a squarefree polynomial with integer of rational coefficients returns the product of the number fields defined by the irreducible factors.}
