...
{Product of two ideals.}
    ...
    if #gI eq 1 then //better for passing the attributes
        ...
        if assigned I`IsInvertible and assigned J`IsInvertible then
            ...
            // if I and J are invertible, then I*J is generated by two elements
            // this is much better than the set gens obtained above.
            // TwoGeneratingSet(out);
            // tests show that it is slower to always find a 2-generatring set
        end if;
        return out;
    end if;
end intrinsic;
