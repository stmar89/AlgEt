...
<pre><b> MinimalPolynomial</b>(x::AlgEtQElt, F::Fld) -> RngUPolElt</pre>
...
<pre><b> Conductor</b>(O::AlgEtQOrd) ->AlgEtQIdl</pre>
...
<pre><b> RepresentativeMap</b>(W::AlgEtQWECM)->Map</pre>
...
<pre><b> RepresentativeMap</b>(icm::AlgEtQICM)->Map</pre>
